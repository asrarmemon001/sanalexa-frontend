                            ...
                            <div className="d-flex flex-wrap row g-0">
                                ...
                                <div className="col-md-3 col-12 m-auto">
                                    <div className="d-flex justify-content-end w-100">
                                        <button className="btn btn-danger my-4 mr-3 text-white" target="_blank" rel="noreferrer" onClick={(e) => playTypeModal('play')} data-toggle="tooltip" data-original-title="Play">
                                            Play
                                        </button> 
                                    </div>
                                </div>
