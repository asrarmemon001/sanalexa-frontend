...
import { verifyOTPApi } from "../../utils/api-Request";
...
const OTPVerification = ({ handleModal, show, setIsLoggedin, modalPayload }) => {
  ...
  return (
    <Modal show={show} onHide={() => { }} centered>
      ...
      {console.log(formik, 's', modalPayload)}
      <Modal.Body>
        ...
        <form className="text-start otp-form" onSubmit={formik.handleSubmit}>
          ...
          {/* <p className="mt-4 text-sm text-center">
            Not received{' '}
            <span className="text-primary" style={{ cursor: 'pointer' }} onClick={() => handleModal("signup")}>Resend OTP</span>
          </p> */}
          <p className="mt-4 text-sm text-center">
