                  ...
                  <div className="packageItem px-3 mb-2" key={index}>
                    ...
                    >
                      ...
                      <li onClick={()=>handlePackageFav(isPackagesWishListed(obj?.id, favProjects) ? "remove" : "add", obj?.id)}>
                        ...
                        <svg className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-i4bv87-MuiSvgIcon-root" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="FavoriteBorderIcon">
